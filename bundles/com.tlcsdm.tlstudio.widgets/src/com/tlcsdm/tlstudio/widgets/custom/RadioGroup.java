...
public class RadioGroup extends Composite {
	...
	/**
	 * Reset the button at position <code>position</code> (reset content to empty
	 * string, reset font, images...)
	 *
	 * @param listener the listener which should be notified
	 *
	 * @exception SWTException
	...
	/**
	 * Returns a (possibly empty) array of <code>RadioItem</code>s which are the
	 ...
	 *                                     does not exist in this widget</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
	 *                                     <li>ERROR_WIDGET_DISPOSED - if the
