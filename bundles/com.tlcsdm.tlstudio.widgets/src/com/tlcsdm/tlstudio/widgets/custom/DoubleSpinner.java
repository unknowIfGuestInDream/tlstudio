...
/**
 * A spinner class that supports double numbers
 */
public class DoubleSpinner extends Composite {
	 ...
	 * @param precision
	 */
	public DoubleSpinner(Composite parent, int style, int width, int precision) {
	...
	/**
	 * Method creates a right-click menu for a DoubleSpinner with options for
	 * resetting to original value, and for setting the increment.
	 * 
	 * @param increments  an array of doubles representing the different increments
	 *                    allowed
				...
				popupMenu.add(new Action("Reset") {
					...
					public void run() {
						...
						try {
							...
							WidgetsUtility.logException(e, "Can't invoke method (illegal argument).");
						} catch (IllegalAccessException e) {
							WidgetsUtility.logException(e, "Can't invoke method (illegal access).");
						} catch (InvocationTargetException e) {
							WidgetsUtility.logException(e, "Can't invoke method (invokation target).");
						}
					}
				});
