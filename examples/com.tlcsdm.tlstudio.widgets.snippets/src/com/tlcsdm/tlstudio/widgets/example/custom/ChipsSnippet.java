...
import com.tlcsdm.tlstudio.widgets.custom.Chips;
import com.tlcsdm.tlstudio.widgets.custom.ChipsCloseListener;
...
public class ChipsSnippet {
	...
	private static void createCloseChipsArea() {
		...
		final ChipsCloseListener closeListener = event -> {
	...
	private static Image loadImage(final String img) {
		return new Image(shell.getDisplay(), ChipsSnippet.class.getClassLoader()
				.getResourceAsStream("com/tlcsdm/tlstudio/widgets/example/custom/chips/" + img));
	}
	...
	private static void createPushChipsArea() {
		...
		chip1.setPushedStateBackground(checkColor);
		chip1.setImage(loadImage("bubble1_b.png"));
		chip1.setPushImage(loadImage("bubble1_w.png"));
		chip1.setText("One");
		...
		chip2.setPushedStateBackground(checkColor);
		chip2.setImage(loadImage("bubble2_b.png"));
		chip2.setPushImage(loadImage("bubble2_w.png"));
		...
		chip3.setPushedStateBackground(checkColor);
		chip3.setImage(loadImage("bubble3_b.png"));
		chip3.setPushImage(loadImage("bubble3_w.png"));
		...
		chip4.setPushedStateBackground(checkColor);
		chip4.setImage(loadImage("email_b.png"));
		chip4.setPushImage(loadImage("email_w.png"));
