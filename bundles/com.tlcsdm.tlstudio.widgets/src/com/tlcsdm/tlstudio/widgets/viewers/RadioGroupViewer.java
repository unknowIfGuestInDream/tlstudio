...
public class RadioGroupViewer extends AbstractListViewer {
	...
	/**
	 * Creates a radio group viewer on a newly-created {@link RadioGroup} control
	 * under the given parent. The viewer has no input, no content provider, a
	...
	/**
	 * Creates a radio group viewer on a newly-created {@link RadioGroup} control
	 * under the given parent. The radio group control is created using the given
	 ...
	 *
	 * @param group the RadioGroup control
	 */
