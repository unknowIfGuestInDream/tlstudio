 ...
 * </dl>
 */
public class SwitchButton extends AbstractCustomCanvas {
	...
	/**
	 * @param round the round flag to set. If true, the widget is composed of round
	 *              rectangle instead of rectangles
	 * @exception SWTException
	 *                         <ul>
	 *                         <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	 *                         disposed</li>
	...
	/**
	 * @param the foreground color of the left part of the widget (selection is on)
	 * @exception SWTException
	 *                         <ul>
	 *                         <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	 *                         disposed</li>
	...
	/**
	 * @param the background color of the left part of the widget (selection is on)
	 */
	...
	/**
	 * @param unselectedForegroundColor the foreground color of the left part of the
	...
	/**
	 * @param unselectedBackgroundColor the background color of the left part of the
	 *                                  widget (selection is on)
	 * @exception SWTException
	 *                         <ul>
	 *                         <li>ERROR_WIDGET_DISPOSED - if the receiver has been
