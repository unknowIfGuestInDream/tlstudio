package com.tlcsdm.tlcsdm.widgets.tests.custom;
...
public class RadioGroupTest extends TestCase {
	...
	private void assertEvent(int eventType, RadioItem item, int index, Event event) {
		assertNotNull(event);
	...
	public void testNewItemWithIndex() {
		...
		Control[] expectedButtons = { item2.getButton(), item1.getButton(), item3.getButton() };
