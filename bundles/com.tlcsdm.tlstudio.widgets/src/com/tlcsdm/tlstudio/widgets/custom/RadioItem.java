...
public class RadioItem extends Item {
	 ...
	 * describing its behavior and appearance. The item is added to the end of the
	...
	/**
	 * Constructs a new instance of this class given its parent and a style value
	 * describing its behavior and appearance, and the index at which to place it in
	 ...
	 *               be null)
	 * @param style  the style of item to construct
	 * @param index  the zero-relative index at which to store the receiver in its
	 *               parent
	 *
	 * @exception IllegalArgumentException
	 *                                     <ul>
	 ...
	 * selected when it is pushed in. If the receiver is of any other type, this
