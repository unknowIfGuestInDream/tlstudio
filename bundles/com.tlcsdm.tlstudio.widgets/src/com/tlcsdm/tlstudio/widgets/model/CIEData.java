...
public class CIEData {
	...
	// x + y + z = 1
	private double normalizedX, normalizedY, normalizedZ;
	// y = 1;
	...
	public static double[] XYZd65toSRGBd65Linear(double[] xyzd65) {
		double[][] matrix = { { 3.2409699419045235, -1.5373831775700944, -0.49861076029300355 },
	...
	public static double[] D50toD65(double[] d50) {
		double[][] matrix = { { 0.9555766, -0.0230393, 0.0631636 }, { -0.0282895, 1.0099416, 0.0210077 },
