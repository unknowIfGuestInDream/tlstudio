...
public class Perspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.createFolder("rightTop1", IPageLayout.TOP, 0.5f, "right").addView(BROWSER_VIEWID);
		layout.createFolder("rightBottom", IPageLayout.TOP, 0.25f, "right").addView(PAINT_VIEWID);
	}
